...
document.getElementById('grid').addEventListener('click',e=>{{const b=e.target.closest('.play');if(!b)return;stop();b.parentElement.parentElement.classList.add('hit');cur=b;audio.src=b.dataset.audio;audio.play().catch(()=>alert('此设备不支持播放'));}});
